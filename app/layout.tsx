...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={`${inter.className} antialiased tracking-tight bg-neutral-100 dark:bg-neutral-950 text-gray-900 dark:text-gray-50 selection:bg-yellow-500 selection:text-white dark:selection:text-black sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl mx-auto px-4 sm:px-6 xl:px-0 gap-10 sm:gap-14`}>
        <ThemeProvider>
          <div className="min-h-screen flex flex-col max-w-2xl mx-auto px-4">
            <Header />
            <main className='flex-grow px-4 py-8 bg-neutral-50/50 dark:bg-neutral-900/50 rounded-lg border border-neutral-200/50 dark:border-neutral-800/50 shadow-sm'>
              {children}
            </main>
            <Footer />
          </div>
