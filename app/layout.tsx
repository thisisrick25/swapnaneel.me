...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={`${inter.className} antialiased tracking-tight bg-neutral-200 dark:bg-neutral-950 text-gray-900 dark:text-gray-50 selection:bg-neutral-400 selection:text-black dark:selection:bg-neutral-600 dark:selection:text-white sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl mx-auto px-4 sm:px-6 xl:px-0 gap-10 sm:gap-14`}>
        <ThemeProvider>
