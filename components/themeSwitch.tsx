...
export default function ThemeSwitch() {
  ...
  return (
    <button
      ...
      className="px-2 py-2 text-black dark:text-white inline-flex items-center justify-center h-9 w-9 rounded-md hover:bg-neutral-400/80 dark:hover:bg-neutral-600/80 duration-300 ease-in transition-colors"
    >
