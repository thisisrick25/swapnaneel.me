...
export default function ThemeSwitch() {
  ...
  return (
    <button
      ...
      className="cursor-pointer p-2 text-black dark:text-white inline-flex items-center justify-center rounded-md hover:bg-neutral-200 dark:hover:bg-neutral-800 duration-300 ease-in transition-colors"
    >
