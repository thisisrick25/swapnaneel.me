...
```html showLineNumbers {1-5} /science/ title="index.html" caption="this file contains html code"
...
```js showLineNumbers {1-2} /science/ title="index.html" caption="this file contains html code"
module.exports = {
  purge: [],
  theme: {
    extend: {},
